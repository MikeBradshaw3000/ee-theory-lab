...
with open("phase_4b/scripts/tier3_regression.py", "w", encoding="utf-8") as f:
    f.write(script_content)

print("SUCCESS: tier3_regression.py updated!")